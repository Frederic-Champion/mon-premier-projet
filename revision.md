...
_Auto-éval initiale : 08/06/2026 (134/142 notions, moyenne 5.8/10)._
_Révisions menées du 08 au 12/06/2026 — règle appliquée : toute notion < 6/10 révisée jusqu'à maîtrise._
...
_Pas des trous — des choses comprises à faire mûrir par la répétition._
...
_Moyenne globale de départ : 5.8/10 — à comparer au prochain passage du quiz._
_Points forts : DOM 8.6 · Tailwind 6.4 · HTML 6.2 / Points faibles : Outils 2.8 · Tableaux&objets 4.8._
_(scores d'origine conservés ci-dessous comme base de comparaison — NE PAS modifier)_
...
- Git/GitHub 5.4 · HTML 6.2 · CSS boîte 6.0 · CSS flex/grid 5.0 · CSS position 5.0 ·
  ...
  ## 📋 AUTO-ÉVALUATION DE SUIVI — 25-26/06/2026 (photo "après" fin Phase 1)

  _Quiz complet refait (15 domaines). Moyenne globale : 5,8 → 7,2 (+1,4)._
  _Aucun domaine en recul. Les 3 ex-points faibles de juin parmi les plus gros bonds._

| Domaine            | 08/06 | 26/06 | Δ     |
| ------------------ | ----- | ----- | ----- |
| Git/GitHub         | 5,4   | 5,6   | +0,2  |
| HTML               | 6,2   | 7,3   | +1,1  |
| CSS boîte          | 6,0   | 7,7   | +1,7  |
| CSS flex/grid      | 5,0   | 5,75  | +0,75 |
| CSS position       | 5,0   | 7,05  | +2,05 |
| CSS sélecteurs     | 5,6   | 7,6   | +2,0  |
| Tailwind           | 6,4   | 7,58  | +1,18 |
| JS bases           | 6,2   | 7,7   | +1,5  |
| JS tableaux/objets | 4,8   | 7,4   | +2,6  |
| JS HOF             | 6,0   | 6,2   | +0,2  |
| JS DOM             | 8,6   | 8,6   | =     |
| JS événements      | 5,0   | 7,75  | +2,75 |
| JS fetch           | 5,7   | 7,5   | +1,8  |
| JS APIs natives    | 5,2   | 7,79  | +2,59 |
| Outils             | 2,8   | 6,92  | +4,12 |

**3 poches à entretenir (non bloquantes) :**

- map / find / some — sous-utilisées (React fera remonter map tout seul)
- placement Grid (col-span, grid-column 1/-1) — resté à 3, micro-exo 15 min
- famille align-\* (justify/align confondus) — mémo "justify suit l'axe principal"
